...
def test_base_prompt_has_an_exact_stable_shape(tmp_path: Path) -> None:
    ...
    assert prompt == (
        ...
        "expose secrets or write credentials into the repository. Protected tools may require "
        "explicit approval; treat a denial as final for that call and choose a safer "
        "alternative.\n"
